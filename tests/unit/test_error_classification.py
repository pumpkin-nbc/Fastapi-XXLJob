...
from fastapi_xxljob.client import (
    ERROR_BUSINESS,
    ERROR_CONFIG,
    ERROR_HTTP,
    ERROR_INVALID_JSON,
...
def test_success_has_no_error_type(mocker):
    mocker.patch("fastapi_xxljob.client.requests.post", return_value=FakeResponse(200))
    result = call()
...
def test_invalid_response_constant_is_client_only_public_api():
    ...
    assert not hasattr(fastapi_xxljob, "ERROR_INVALID_RESPONSE")

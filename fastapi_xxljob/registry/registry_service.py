...
class RegistryService:
    ...
    _DISABLED_ERROR = "FastAPI-XXLJob is disabled."
    ...
    def __init__(
        ...
        self._logger = logger or logging.getLogger("fastapi_xxljob.registry")
    ...
    def _settle_prepared_after_publish_failure(
        ...
        """Settle only an exact Prepared token after router publication."""
        state = prepared.state
        ...
        try:
            ...
            self._logger.exception(
                ...
                "router publication; Runtime and Worker ownership are "
        ...
        *,
        ...
        with state.state_lock:
            ...
            thread = threading.Thread(
                ...
                name="fastapi-xxljob-registry-remove",
                daemon=True,
            )

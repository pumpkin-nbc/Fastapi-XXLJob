...
def main() -> int:
    ...
    if _pyproject_name() != "fastapi-xxljob":
        errors.append("pyproject name must be 'fastapi-xxljob'")
    readme = (ROOT / "README.md").read_text(encoding="utf-8")
    if "fastapi_xxljob" not in readme:
        errors.append("README.md must reference the import package 'fastapi_xxljob'")

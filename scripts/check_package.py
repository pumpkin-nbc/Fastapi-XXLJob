...
EXPECTED_REPOSITORY = "https://github.com/pumpkin-nbc/Fastapi-XXLJob"
...
def _check_wheel(path: Path, errors: List[str]) -> ArtifactInfo:
    ...
    with archive:
        ...
        required_files = (
            "fastapi_xxljob/__init__.py",
            "fastapi_xxljob/_version.py",
            "fastapi_xxljob/py.typed",
        )
...
def _check_sdist(path: Path, errors: List[str]) -> ArtifactInfo:
    ...
    with archive:
        ...
        required = (
            ...
            f"{EXPECTED_TOP_LEVEL}/fastapi_xxljob/__init__.py",
            f"{EXPECTED_TOP_LEVEL}/fastapi_xxljob/_version.py",
            f"{EXPECTED_TOP_LEVEL}/fastapi_xxljob/py.typed",
